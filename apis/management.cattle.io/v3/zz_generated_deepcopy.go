...
func (in *F5BIGIPProviderConfig) DeepCopyInto(out *F5BIGIPProviderConfig) {
	*out = *in
	if in.F5BIGIPDeviceIPS != nil {
		in, out := &in.F5BIGIPDeviceIPS, &out.F5BIGIPDeviceIPS
		*out = make([]ServerAddresse, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerAddresse) DeepCopyInto(out *ServerAddresse) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerAddresse.
func (in *ServerAddresse) DeepCopy() *ServerAddresse {
	if in == nil {
		return nil
	}
	out := new(ServerAddresse)
	in.DeepCopyInto(out)
	return out
}
