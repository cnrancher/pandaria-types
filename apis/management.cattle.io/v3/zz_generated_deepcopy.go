...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CASLogoutOutput) DeepCopyInto(out *CASLogoutOutput) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CASLogoutOutput.
func (in *CASLogoutOutput) DeepCopy() *CASLogoutOutput {
	if in == nil {
		return nil
	}
	out := new(CASLogoutOutput)
	in.DeepCopyInto(out)
	return out
}
